...
public:
  ...
  NoBackhaulEpcHelper (std::string ip1, std::string ip2, std::string ip3, std::string ip4, std::string ip5);
  /**
   * Destructor
   */
  ...
  virtual void AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId);
  ...
  virtual void AddS1Interface (Ptr<Node> enb, Ipv4Address enbAddress, Ipv4Address sgwAddress, uint16_t cellId);
  ...
  virtual void OverrideIP(std::string ip);
...
private:
  ...
  Ipv4AddressHelper m_subPgwAddressHelper;
  /**
