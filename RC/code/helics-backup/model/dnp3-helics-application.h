...
#ifndef DNP3_HELICS_APPLICATION_H
#define DNP3_HELICS_APPLICATION_H
 ...
 */
class Dnp3HelicsApplication : public Application, public EventInterface
{
public:
  ...
  Dnp3HelicsApplication ();

  virtual ~Dnp3HelicsApplication ();
  ...
  void send_control_binary(Dnp3HelicsApplication::ControlType type, DnpIndex_t index, ControlOutputRelayBlock::Code code);
  void send_control_analog(Dnp3HelicsApplication::ControlType type, DnpIndex_t index, double value);
...
#endif /* DNP3_HELICS_APPLICATION_H */
