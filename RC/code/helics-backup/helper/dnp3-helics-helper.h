 ...
 */
#ifndef DNP3_HELICS_HELPER_H
#define DNP3_HELICS_HELPER_H
 ...
 * on a set of nodes.
 */
class Dnp3HelicsApplicationHelper
{
public:
  /**
   * Create a Dnp3HelicsApplicationHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  Dnp3HelicsApplicationHelper (std::string protocol, Address address);
  ...
  Ptr<Dnp3HelicsApplication> Install (Ptr<Node> node, const std::string &name);
...
private:
   ...
   */
  Ptr<Dnp3HelicsApplication> InstallPriv (Ptr<Node> node) const;

  Ptr<Dnp3HelicsApplication> InstallPriv (Ptr<Node> node, const std::string &name);
