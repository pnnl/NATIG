...
#include "internet-stack-helper-MIM.h"
...
NS_LOG_COMPONENT_DEFINE ("InternetStackHelperMIM");
...
InternetStackHelperMIM::InternetStackHelperMIM ()
  : m_routing (0),
    m_routingv6 (0),
    m_ipv4Enabled (true),
    m_ipv6Enabled (true),
...
void
InternetStackHelperMIM::Initialize ()
{
...
InternetStackHelperMIM::InternetStackHelperMIM (const InternetStackHelperMIM &o)
{
...
InternetStackHelperMIM &
InternetStackHelperMIM::operator = (const InternetStackHelperMIM &o)
{
  if (this == &o)
    {
      return *this;
...
void
InternetStackHelperMIM::Reset (void)
{
  delete m_routing;
  m_routing = 0;
  delete m_routingv6;
...
void 
InternetStackHelperMIM::SetRoutingHelper (const Ipv4RoutingHelper &routing)
{
  delete m_routing;
...
void
InternetStackHelperMIM::SetRoutingHelper (const Ipv6RoutingHelper &routing)
{
  delete m_routingv6;
...
void
InternetStackHelperMIM::SetIpv4StackInstall (bool enable)
{
  m_ipv4Enabled = enable;
}

void InternetStackHelperMIM::SetIpv6StackInstall (bool enable)
{
  m_ipv6Enabled = enable;
}

void InternetStackHelperMIM::SetIpv4ArpJitter (bool enable)
{
  m_ipv4ArpJitterEnabled = enable;
}

void InternetStackHelperMIM::SetIpv6NsRsJitter (bool enable)
{
  m_ipv6NsRsJitterEnabled = enable;
}

int64_t
InternetStackHelperMIM::AssignStreams (NodeContainer c, int64_t stream)
{
...
void
InternetStackHelperMIM::SetTcp (const std::string tid)
{
  m_tcpFactory.SetTypeId (tid);
}

void 
InternetStackHelperMIM::SetTcp (std::string tid, std::string n0, const AttributeValue &v0)
{
  m_tcpFactory.SetTypeId (tid);
...
void 
InternetStackHelperMIM::Install (NodeContainer c) const
{
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Install (*i);
...
void 
InternetStackHelperMIM::InstallAll (void) const
{
  Install (NodeContainer::GetGlobal ());
}

void
InternetStackHelperMIM::CreateAndAggregateObjectFromTypeId (Ptr<Node> node, const std::string typeId)
{
...
void
InternetStackHelperMIM::Install (Ptr<Node> node) const
{
  bool f = true;
  if (m_ipv4Enabled)
    {
      ...
      {
	  f = false;
	  CreateAndAggregateObjectFromTypeId (node, "ns3::Ipv4L3ProtocolMIM");
	  //Ptr<ArpL3Protocol> arp = node->GetObject<ArpL3Protocol> ();
	  //Ptr<TrafficControlLayer> tc = node->GetObject<TrafficControlLayer> ();
	  //NS_ASSERT (arp);
	  //NS_ASSERT (tc);
	  //arp->SetTrafficControl (tc);
          //NS_FATAL_ERROR ("InternetStackHelperMIM::Install (): Aggregating " 
          //                "an InternetStack to a node with an existing Ipv4 object");
          //return;
      }
      else{
        CreateAndAggregateObjectFromTypeId (node, "ns3::ArpL3Protocol");
        CreateAndAggregateObjectFromTypeId (node, "ns3::Ipv4L3ProtocolMIM"); //was MIM here
  ...
  if ((m_ipv4Enabled || m_ipv6Enabled) && f)
    {
...
void
InternetStackHelperMIM::Install (std::string nodeName) const
{
...
bool
InternetStackHelperMIM::PcapHooked (Ptr<Ipv4> ipv4)
{
...
void 
InternetStackHelperMIM::EnablePcapIpv4Internal (std::string prefix, Ptr<Ipv4> ipv4, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv4))
    {
      ...
      NS_ASSERT_MSG (ipv4L3Protocol, "InternetStackHelperMIM::EnablePcapIpv4Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "InternetStackHelperMIM::EnablePcapIpv4Internal():  "
...
bool
InternetStackHelperMIM::PcapHooked (Ptr<Ipv6> ipv6)
{
...
void 
InternetStackHelperMIM::EnablePcapIpv6Internal (std::string prefix, Ptr<Ipv6> ipv6, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv6))
    {
      ...
      NS_ASSERT_MSG (ipv6L3Protocol, "InternetStackHelperMIM::EnablePcapIpv6Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "InternetStackHelperMIM::EnablePcapIpv6Internal():  "
...
Ipv4L3ProtocolDropSinkWithoutContext (
  ...
  Ipv4L3ProtocolMIM::DropReason reason, 
  Ptr<Ipv4> ipv4, 
  uint32_t interface)
{
  //
...
bool
InternetStackHelperMIM::AsciiHooked (Ptr<Ipv4> ipv4)
{
...
void 
InternetStackHelperMIM::EnableAsciiIpv4Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv4> ipv4, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv4))
        {
          ...
          NS_ASSERT_MSG (result == true, "InternetStackHelperMIM::EnableAsciiIpv4Internal():  "
...
bool
InternetStackHelperMIM::AsciiHooked (Ptr<Ipv6> ipv6)
{
...
void 
InternetStackHelperMIM::EnableAsciiIpv6Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv6> ipv6, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv6))
        {
          ...
          NS_ASSERT_MSG (result == true, "InternetStackHelperMIM::EnableAsciiIpv6Internal():  "
