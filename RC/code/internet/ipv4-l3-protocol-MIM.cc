...
#include "arp-cache.h"
#include "ipv4-l3-protocol-MIM.h"
...
NS_LOG_COMPONENT_DEFINE ("Ipv4L3ProtocolMIM");

const uint16_t Ipv4L3ProtocolMIM::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (Ipv4L3ProtocolMIM);
...
TypeId 
Ipv4L3ProtocolMIM::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4L3ProtocolMIM")
    .SetParent<Ipv4L3Protocol> () //Ipv4> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4L3ProtocolMIM> ()
    /*.AddAttribute ("DefaultTtl",
                   "The TTL value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&Ipv4L3ProtocolMIM::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments "
                   "will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&Ipv4L3ProtocolMIM::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("EnableDuplicatePacketDetection",
                   "Enable multicast duplicate packet detection based on RFC 6621",
                   BooleanValue (false),
                   MakeBooleanAccessor (&Ipv4L3ProtocolMIM::m_enableDpd),
                   MakeBooleanChecker ())
    .AddAttribute ("DuplicateExpire", "Expiration delay for duplicate cache entries",
                   TimeValue (MilliSeconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolMIM::m_expire),
                   MakeTimeChecker ())
    .AddAttribute ("PurgeExpiredPeriod", 
                   "Time between purges of expired duplicate packet entries, "
                   "0 means never purge",
                   TimeValue (Seconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolMIM::m_purge),
                   MakeTimeChecker (Seconds (0)))
    .AddTraceSource ("Tx",
                     "Send ipv4 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMIM::m_txTrace),
                     "ns3::Ipv4L3ProtocolMIM::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive ipv4 packet from incoming interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMIM::m_rxTrace),
                     "ns3::Ipv4L3ProtocolMIM::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop ipv4 packet",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolMIM::m_dropTrace),
                     "ns3::Ipv4L3ProtocolMIM::DropTracedCallback")
    .AddAttribute ("InterfaceList",
                   "The set of Ipv4 interfaces associated to this Ipv4 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&Ipv4L3ProtocolMIM::m_interfaces),
...
Ipv4L3ProtocolMIM::Ipv4L3ProtocolMIM()
{
...
void
Ipv4L3ProtocolMIM::Insert (Ptr<IpL4Protocol> protocol)
{
...
void
Ipv4L3ProtocolMIM::Insert (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void
Ipv4L3ProtocolMIM::Remove (Ptr<IpL4Protocol> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void
Ipv4L3ProtocolMIM::Remove (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolMIM::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolMIM::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
void
Ipv4L3ProtocolMIM::SetNode (Ptr<Node> node)
{
...
Ptr<Socket> 
Ipv4L3ProtocolMIM::CreateRawSocket (void)
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolMIM::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
Ipv4L3ProtocolMIM::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION (this);
  if (m_node == 0)
    {
...
void 
Ipv4L3ProtocolMIM::SetRoutingProtocol (Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
Ipv4L3ProtocolMIM::GetRoutingProtocol (void) const
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolMIM::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMIM::SetupLoopback (void)
{
  NS_LOG_FUNCTION (this);
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolMIM::Receive, this), 
                                 Ipv4L3ProtocolMIM::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
Ipv4L3ProtocolMIM::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
Ipv4L3ProtocolMIM::AddInterface (Ptr<NetDevice> device)
{
  ...
  NS_ASSERT (tc != 0);
  NS_LOG_UNCOND ("IN ADD INTERFACE!!!!!!!!!!!!!!");
  ...
  tc->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolMIM::Receive, this),
                               Ipv4L3ProtocolMIM::PROT_NUMBER, device);
...
uint32_t 
Ipv4L3ProtocolMIM::AddIpv4Interface (Ptr<Ipv4Interface>interface)
{
...
Ptr<Ipv4Interface>
Ipv4L3ProtocolMIM::GetInterface (uint32_t index) const
{
...
uint32_t 
Ipv4L3ProtocolMIM::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
Ipv4L3ProtocolMIM::GetInterfaceForAddress (
...
int32_t 
Ipv4L3ProtocolMIM::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
Ipv4L3ProtocolMIM::GetInterfaceForDevice (
...
bool
Ipv4L3ProtocolMIM::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
  ...
  for (uint32_t i = 0; i < GetNAddresses (iif); i++)
    {
      ...
      NS_LOG_INFO ("Ipv4L3ProtocolMIM::IsDestinationAddress >>> iaddr.GetLocal (): " << iaddr.GetLocal ());

      if (address == iaddr.GetLocal ()){
         	  NS_LOG_INFO ("Ipv4L3ProtocolMIM::IsDestinationAddress >>> MITM is the final address");
         	  mitm_flag = true;
		  //return true;
      }
...
void 
Ipv4L3ProtocolMIM::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  NS_LOG_FUNCTION (this << device << p << protocol << from << to << packetType);

  NS_LOG_INFO ("Ipv4L3ProtocolMIM::Receive >>> Packet from " << from << " received on node " <<
		                  m_node->GetId ());
  NS_LOG_INFO ("Ipv4L3ProtocolMIM::Receive >>> Packet to " << to);
  ...
  outfile <<Simulator::Now ().GetSeconds ()<<";receive;" << p->GetSize() << ";" << ipHeaderss.GetSource() << ";" << ipHeaderss.GetDestination() << ";" << this->GetObject<Node> ()->GetObject<Ipv4> ()->GetAddress (1,0) << "\n";

  //Adding jitter to the packet that is captured
  ...
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&Ipv4L3ProtocolMIM::IpForward, this),
                                      MakeCallback (&Ipv4L3ProtocolMIM::IpMulticastForward, this),
                                      MakeCallback (&Ipv4L3ProtocolMIM::LocalDeliver, this),
                                      MakeCallback (&Ipv4L3ProtocolMIM::RouteInputError, this)
                                      ))
    {
...
Ipv4L3ProtocolMIM::GetIcmp (void) const
{
  NS_LOG_FUNCTION (this);
...
bool
Ipv4L3ProtocolMIM::IsUnicast (Ipv4Address ad) const
{
...
bool
Ipv4L3ProtocolMIM::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
Ipv4L3ProtocolMIM::SendWithHeader (Ptr<Packet> packet, 
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
  ...
  NS_LOG_UNCOND("WIIIIIITHHH HEADER!!!!!!!");
  SendRealOut (route, packet, ipHeader);
}

void
Ipv4L3ProtocolMIM::CallTxTrace (const Ipv4Header & ipHeader, Ptr<Packet> packet,
...
void 
Ipv4L3ProtocolMIM::Send (Ptr<Packet> packet, 
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
  ...
  //Add Jitter in Send function
  NS_LOG_UNCOND("ADDING JITTER TO THE PACKET");
  //Ptr<ArpL3Protocol> arp = m_node->GetObject<ArpL3Protocol> ();
  //NS_ASSERT (arp);
  //arp->SetAttribute ("RequestJitter", StringValue ("ns3::UniformRandomVariable[Min=5.0|Max=15.0]"));
      ...
      if (!route->GetGateway ().IsInitialized ())
        {
          ...
          // to be queried).
          NS_FATAL_ERROR ("Ipv4L3ProtocolMIM::Send case 1a: packet passed with a route but the Gateway address is uninitialized. This case not yet implemented.");
        }

      // 1b) with a valid gateway
      NS_LOG_UNCOND ("Ipv4L3ProtocolMIM::Send case 1b:  passed in with route and valid gateway");
  ...
  if (destination.IsBroadcast () || destination.IsLocalMulticast ())
    {
      NS_LOG_LOGIC ("Ipv4L3ProtocolMIM::Send case 2:  limited broadcast - no route");
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("Ipv4L3ProtocolMIM::Send case 3:  subnet directed bcast to " << ifAddr.GetLocal () << " - no route");
              // create a proxy route for this interface
              Ptr<Ipv4Route> route = Create<Ipv4Route> ();
              route->SetDestination (destination);
              route->SetGateway (Ipv4Address::GetAny ());
  ...
  NS_LOG_LOGIC ("Ipv4L3ProtocolMIM::Send case 4:  not broadcast and passed in with no route " << destination);
...
void
Ipv4L3ProtocolMIM::DecreaseIdentification (Ipv4Address source,
                                        Ipv4Address destination,
                                        uint8_t protocol)
{
...
void
Ipv4L3ProtocolMIM::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
                             Ipv4Header const &ipHeader)
{
  NS_LOG_FUNCTION (this << route << packet << &ipHeader);

  NS_LOG_INFO ("Ipv4L3ProtocolMIM::SendRealOut >>> " << this << " route: " << route <<  " packet: " << packet <<  " &ipHeader: " << &ipHeader);
  if (route == 0)
	        {
       NS_LOG_WARN ("No route to host.  Drop.");
       m_dropTrace (ipHeader, packet, DROP_NO_ROUTE, m_node->GetObject<Ipv4> (), 0);
  ...
  //sourceAddr = ipHead.GetSource();
  //victimAddr = ipHead.GetDestination();
  NS_LOG_UNCOND("Ipv4L3ProtocolMIM::GetDestination: " << ipHeader.GetDestination() << "Source: " << sourceAddr << "victim address: " << victimAddr << " GetSource(): " << ipHeader.GetSource());
  std::stringstream s2;
  s2 << ipHeader.GetDestination();
  if(ipHeader.GetDestination() == victimAddr or (s2.str().find("172.17.0.3") != std::string::npos and victimAddr != Ipv4Address("102.102.102.102"))){
    //route->SetSource(sourceAddr);
    ipHead.SetSource(sourceAddr);
  }else if(victimAddr != Ipv4Address("102.102.102.102")){
    std::cout << "THE DESTINATION IS: " << ipHead.GetDestination() << std::endl;
    ipHead.SetSource(destAddr);
  }

  if (route == 0)
    {
      NS_LOG_WARN ("No route to host.  Drop.");
      m_dropTrace (ipHead, packet, DROP_NO_ROUTE, m_node->GetObject<Ipv4> (), 0);
      return;
    }
  ...
  NS_LOG_INFO ("Send via NetDevice ifIndex " << outDev->GetIfIndex () << " ipv4InterfaceIndex " << interface);
  ...
  std::ofstream outfile;
  outfile.open("PerNodePerf.csv", std::ios_base::app); // append instead of overwrite
  outfile << Simulator::Now ().GetSeconds ()<<";send;" << packet->GetSize() << ";" << ipHeaderss.GetSource() << ";" << ipHeaderss.GetDestination() << ";" << this->GetObject<Node> ()->GetObject<Ipv4> ()->GetAddress (1,0) << "\n";
  ...
  if (outInterface->IsUp ())
    {
      NS_LOG_INFO ("Send to " << targetLabel << " " << target);
      NS_LOG_INFO (packet->GetSize());
      NS_LOG_INFO (ipHead.GetSerializedSize ());
      NS_LOG_INFO (outInterface->GetDevice ()->GetMtu ());
      NS_LOG_INFO ("------------------------------------");
      ...
      if ( packet->GetSize () + ipHead.GetSerializedSize () > outInterface->GetDevice ()->GetMtu () )
        {
          ...
          for ( std::list<Ipv4PayloadHeaderPair>::iterator it = listFragments.begin (); it != listFragments.end (); it++ )
            {
              NS_LOG_INFO ("Sending fragment " << *(it->first) );
	  ...
	  NS_LOG_INFO ("AFter outerstation");
        }
    }
}
...
void
Ipv4L3ProtocolMIM::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  NS_LOG_FUNCTION (this << mrtentry << p << header);
  NS_LOG_UNCOND ("Multicast forwarding logic for node: " << m_node->GetId ());
  ...
  for (mapIter = ttlMap.begin (); mapIter != ttlMap.end (); mapIter++)
    {
      ...
      NS_LOG_UNCOND ("Forward multicast via interface " << interface);
...
void
Ipv4L3ProtocolMIM::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  NS_LOG_UNCOND("HEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");
  m_unicastForwardTrace (ipHeader, packet, interface);
  SendRealOut (rtentry, packet, ipHeader);
}

void
Ipv4L3ProtocolMIM::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
  ...
  destAddr = ipHeader.GetDestination();
  sourceAddr = ipHeader.GetSource();
  ...
  if (protocol != 0)
    {
	  ...
	  NS_LOG_UNCOND(ipHeader.GetDestination());
	  NS_LOG_UNCOND("There is " << GetNAddresses (iif) << " address");
	  NS_LOG_UNCOND("Source is: " << ipHeader.GetSource());
	  NS_LOG_UNCOND("Destination: " << ipHeader.GetDestination());
	  NS_LOG_UNCOND("iif = " << iif);

          for (uint32_t i = 0; i < GetNAddresses (iif); i++)
            {
              Ipv4InterfaceAddress addr = GetAddress (iif, i);
	      NS_LOG_UNCOND("AAAAAAAAAAAAAAAAAHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH");
	      NS_LOG_UNCOND(addr.GetLocal().CombineMask(addr.GetMask ()));
	      NS_LOG_UNCOND(ipHeader.GetDestination ().CombineMask (addr.GetMask ()));
	      NS_LOG_UNCOND(ipHeader.GetDestination ().IsSubnetDirectedBroadcast (addr.GetMask()));
              if ((addr.GetLocal ().CombineMask (addr.GetMask ()) == ipHeader.GetDestination ().CombineMask (addr.GetMask ()) && ipHeader.GetDestination ().IsSubnetDirectedBroadcast (addr.GetMask ())))
                {
                  subnetDirected = true;
                }
            }
          if (subnetDirected == false)
            {
              NS_LOG_UNCOND("Did not find the port");
...
bool
Ipv4L3ProtocolMIM::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
...
Ipv4L3ProtocolMIM::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
...
uint32_t 
Ipv4L3ProtocolMIM::GetNAddresses (uint32_t interface) const
{
  NS_LOG_FUNCTION (this << interface);
...
bool
Ipv4L3ProtocolMIM::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
Ipv4L3ProtocolMIM::RemoveAddress (uint32_t i, Ipv4Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
Ipv4Address
Ipv4L3ProtocolMIM::SourceAddressSelection (uint32_t interfaceIdx, Ipv4Address dest)
{
...
Ipv4Address 
Ipv4L3ProtocolMIM::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
Ipv4L3ProtocolMIM::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
Ipv4L3ProtocolMIM::GetMetric (uint32_t i) const
{
...
uint16_t 
Ipv4L3ProtocolMIM::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
bool 
Ipv4L3ProtocolMIM::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMIM::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMIM::SetDown (uint32_t ifaceIndex)
{
...
bool 
Ipv4L3ProtocolMIM::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolMIM::SetForwarding (uint32_t i, bool val)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
Ptr<NetDevice>
Ipv4L3ProtocolMIM::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
Ipv4L3ProtocolMIM::SetIpForward (bool forward) 
{
...
bool 
Ipv4L3ProtocolMIM::GetIpForward (void) const
{
  NS_LOG_FUNCTION (this);
  return m_ipForward;
}
...
void 
Ipv4L3ProtocolMIM::SetWeakEsModel (bool model)
{
...
bool 
Ipv4L3ProtocolMIM::GetWeakEsModel (void) const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMIM::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
...
void
Ipv4L3ProtocolMIM::DoFragmentation (Ptr<Packet> packet, const Ipv4Header & ipv4Header, uint32_t outIfaceMtu, std::list<Ipv4PayloadHeaderPair>& listFragments)
{
...
bool
Ipv4L3ProtocolMIM::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
...
Ipv4L3ProtocolMIM::Fragments::Fragments ()
  : m_moreFragment (0)
{
  NS_LOG_FUNCTION (this);
}
...
void
Ipv4L3ProtocolMIM::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
Ipv4L3ProtocolMIM::Fragments::IsEntire () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolMIM::Fragments::GetPacket () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolMIM::Fragments::GetPartialPacket () const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolMIM::Fragments::SetTimeoutIter (FragmentsTimeoutsListI_t iter)
{
  m_timeoutIter = iter;
  return;
}

Ipv4L3ProtocolMIM::FragmentsTimeoutsListI_t
Ipv4L3ProtocolMIM::Fragments::GetTimeoutIter ()
{
...
void
Ipv4L3ProtocolMIM::HandleFragmentsTimeout (FragmentKey_t key, Ipv4Header & ipHeader, uint32_t iif)
{
...
bool
Ipv4L3ProtocolMIM::UpdateDuplicate (Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (!m_cleanDpd.IsRunning () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_expire, &Ipv4L3ProtocolMIM::RemoveDuplicates, this);
    }
...
void
Ipv4L3ProtocolMIM::RemoveDuplicates (void)
{
  NS_LOG_FUNCTION (this);
  ...
  if (!m_dups.empty () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_purge, &Ipv4L3ProtocolMIM::RemoveDuplicates, this);
    }
}

Ipv4L3ProtocolMIM::FragmentsTimeoutsListI_t
Ipv4L3ProtocolMIM::SetTimeout (FragmentKey_t key, Ipv4Header ipHeader, uint32_t iif)
{
  Time now = Simulator::Now () + m_fragmentExpirationTimeout;

  if (m_timeoutEventList.empty ())
    {
      m_timeoutEvent = Simulator::Schedule (m_fragmentExpirationTimeout, &Ipv4L3ProtocolMIM::HandleTimeout, this);
    }
  m_timeoutEventList.emplace_back (now, key, ipHeader, iif);

  Ipv4L3ProtocolMIM::FragmentsTimeoutsListI_t iter = --m_timeoutEventList.end();

  return (iter);
}

void
Ipv4L3ProtocolMIM::HandleTimeout (void)
{
  ...
  m_timeoutEvent = Simulator::Schedule (difference, &Ipv4L3ProtocolMIM::HandleTimeout, this);
