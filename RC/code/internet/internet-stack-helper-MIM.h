...
#ifndef INTERNET_STACK_HELPER_MIM_H
#define INTERNET_STACK_HELPER_MIM_H
 ...
 */
class InternetStackHelperMIM : public PcapHelperForIpv4, public PcapHelperForIpv6, 
...
public:
   ...
   */
  InternetStackHelperMIM(void);

  /**
   * Destroy the InternetStackHelper
   */
  virtual ~InternetStackHelperMIM(void);

  /**
   * \brief Copy constructor
   * \param o Object to copy from.
   */
  InternetStackHelperMIM (const InternetStackHelperMIM &o);
...
#endif /* INTERNET_STACK_HELPER_MIM_H */
