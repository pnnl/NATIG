 ...
 * on a set of nodes.
 */
class Dnp3ApplicationHelperNew
{
public:
  /**
   ...
   *
   */
  Dnp3ApplicationHelperNew (std::string protocol, Address address);
  ...
  Ptr<Dnp3ApplicationNew> Install (Ptr<Node> node, const std::string &name);
...
private:
   ...
   */
  Ptr<Dnp3ApplicationNew> InstallPriv (Ptr<Node> node) const;

  Ptr<Dnp3ApplicationNew> InstallPriv (Ptr<Node> node, const std::string &name);
